...
public class MainController {
    ...
    public ResponseEntity<Void> addRoom(String name, Long seats) {
    ...
    public ResponseEntity<Void> updateRoom(@PathVariable("id") long id, @RequestBody Room entity) {
    ...
    public ResponseEntity<Void> deleteRoom(@PathVariable("id") long id) {
        Optional<Room> existingRoom = roomRepository.findById(id);
        if (existingRoom.isPresent()) {
            //set null the room for each track we have
